...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_PAINT:
		...
		*/
		...
		DrawCircle(hdc, horizontal_left + RADIUS, vertical_bottom - RADIUS, RADIUS);
		DrawCircle(hdc, horizontal_right - RADIUS, vertical_bottom - RADIUS, RADIUS);
		DrawCircle(hdc, horizontal_half, vertical_top + RADIUS, RADIUS);
