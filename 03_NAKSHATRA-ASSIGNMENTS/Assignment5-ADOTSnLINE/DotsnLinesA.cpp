...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_PAINT:
		...
		*/
		...
		DrawCircle(hdc, horizontal_half, vertical_one_forth, RADIUS); // top

		DrawCircle(hdc, horizontal_one_forth, vertical_half, RADIUS); // mid
		DrawCircle(hdc, horizontal_one_forth + horizontal_half, vertical_half, RADIUS);

		DrawCircle(hdc, horizontal_one_forth, vertical_half + vertical_one_forth, RADIUS); //bottom
		DrawCircle(hdc, horizontal_half + horizontal_one_forth, vertical_half + vertical_one_forth, RADIUS); 
		...
		p[0].x = horizontal_one_forth;
		p[0].y = vertical_half + vertical_one_forth;

		p[1].x = horizontal_one_forth;
		p[1].y = vertical_half;

		p[2].x = horizontal_half;
		p[2].y = vertical_one_forth;

		p[3].x = horizontal_half + horizontal_one_forth;
		p[3].y = vertical_half;

		p[4].x = horizontal_half + horizontal_one_forth;
		p[4].y = vertical_half + vertical_one_forth;

		p2[0].x = horizontal_one_forth;
		p2[0].y = vertical_half;

		p2[1].x = horizontal_half + horizontal_one_forth;
		p2[1].y = vertical_half;
